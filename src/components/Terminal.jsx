...
const SCRIPT = [
  ...
  { cls: 'tool', delay: 900, text: 'grep -n "archive" src/app/uklad/catalog.ts' },
  { cls: 'dim', delay: 550, text: '  no matches — id is free, context stays tiny' },
  { cls: 'tool', delay: 800, text: 'edit src/app/uklad/catalog.ts      + todosArchive' },
  { cls: 'tool', delay: 800, text: 'edit src/features/todos/events.ts  + regEvent(todosArchive, …)  pure' },
  ...
  { cls: 'tool', delay: 800, text: 'mcp › get_state todosById.42.archived' },
...
export function Terminal() {
  ...
  return (
    <div className="terminal" role="img" aria-label="An AI agent adds a feature, type-checks it, then dispatches an event through Uklad DevTools MCP and verifies the state change against the running app.">
      <div className="terminal__bar">
        ...
        <span className="terminal__title">agent — uklad session</span>
      </div>
